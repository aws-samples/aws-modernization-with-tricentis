...
aws cloudformation create-stack --stack-name Tricentis-Workshop --template-body file://cloudfront-s3-website.yaml --enable-termination-protection
```
...
```
### DO NOT FORGET TO CHANGE THE STACK NAME
aws cloudformation create-stack --stack-name Tricentis-Website-Pipeline --template-body file://pipeline.yaml --capabilities CAPABILITY_NAMED_IAM --enable-termination-protection
```
